...
//```````````````````````````````````````````````````````````````````````````````````````````````````````````````````````
    ...
    var threadModel = db.model('Thread', threadSchema);
    var threadBag = [{
        id: 'c3cbdc38-669a-48f4-88e7-481646202d74',
        name: '神猪的reactive库',
        describe: '',
        members: ['9c4d1442-c9bd-4ddb-9313-355bacdf570a', '7b6e1f55-1455-474e-984e-9681d87b4e8b', '4aaf6cb7-35a1-413b-a80e-b45d00f8397c'],
        c_time: '1411870520000'
    },{
        id: '7f81c833-4971-44d4-9526-82900369a1a1',
        name: '妹子回家,螃蟹怎么办',
        describe: '',
        members: ['9c4d1442-c9bd-4ddb-9313-355bacdf570a', '805487b4-bda8-4540-9a5c-182047c039ae', '5746ac1c-0bfa-4ae0-a2b2-074525c4446b', '4aaf6cb7-35a1-413b-a80e-b45d00f8397c'],
        c_time: '1411953320000'
    },{
        id: '6d64340f-d638-4e5f-9e6e-431b3ae9c814',
        name: 'list筛选条件重构',
        describe: '',
        members: ['9c4d1442-c9bd-4ddb-9313-355bacdf570a', '7b6e1f55-1455-474e-984e-9681d87b4e8b', '4aaf6cb7-35a1-413b-a80e-b45d00f8397c'],
        c_time: '1411200920000'
    }];
    // threadModel.collection.insert(threadBag, callback);
//```````````````````````````````````````````````````````````````````````````````````````````````````````````````````````
    ...
    var msgModel = db.model('Msg', msgSchema);
    var msgBag = [{
